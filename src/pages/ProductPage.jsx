                ...
                <div className="selected-product">
                  <div className="selected-product__left">
                    <figure className="selected-product__img__wrapper">
                      <img
                        src={`https://ecommerce-samurai.up.railway.app/${selectedProduct?.images[imageIndex]}`}
                        alt=""
                  ...
                  <div className="selected-product__right">
                    ...
                    <div className="selected-product__quantity">
                      <span className="selected-product__quantity__span selected-product__quantity__span1">
                        Quantity
                      </span>
                      ...
                      <span className="selected-product__quantity__span selected-product__quantity__span2">
